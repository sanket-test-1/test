                                  ...
                                  child: Container(
                                      ...
                                      child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                              ...
                                              prefixIcon: Container(margin: EdgeInsets.only(left: getHorizontalSize(18.00), top: getVerticalSize(14.00), right: getHorizontalSize(12.00), bottom: getVerticalSize(14.00)), child: Container(height: getSize(20.00), width: getSize(20.00), child: SvgPicture.asset(ImageConstant.imgUserIcon2, fit: BoxFit.fill))),
                                      ...
                                      child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                              ...
                                              focusedBorder: OutlineInputBorder(
                                                  ...
                                                  borderSide: BorderSide(color: ColorConstant.blue50, width: 1)),
                                              disabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(getHorizontalSize(5.00)), borderSide: BorderSide(color: ColorConstant.blue50, width: 1)),
                                              prefixIcon: Container(margin: EdgeInsets.only(left: getHorizontalSize(18.00), top: getVerticalSize(16.25), right: getHorizontalSize(12.00), bottom: getVerticalSize(16.25)), child: Container(height: getSize(15.50), width: getSize(20.00), child: SvgPicture.asset(ImageConstant.imgMessageIcon1, fit: BoxFit.fill))),
                                      ...
                                      child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                              ...
                                              focusedBorder: OutlineInputBorder(
                                                  ...
                                                  borderSide: BorderSide(color: ColorConstant.blue50, width: 1)),
                                              disabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(getHorizontalSize(5.00)), borderSide: BorderSide(color: ColorConstant.blue50, width: 1)),
                                              prefixIcon: Container(margin: EdgeInsets.only(left: getHorizontalSize(18.00), top: getVerticalSize(14.00), right: getHorizontalSize(12.00), bottom: getVerticalSize(14.00)), child: Container(height: getSize(20.00), width: getSize(20.00), child: SvgPicture.asset(ImageConstant.imgPasswordIcon2, fit: BoxFit.fill))),
                                              prefixIconConstraints: BoxConstraints(minWidth: getSize(20.00), minHeight: getSize(20.00)),
                                              filled: true,
                                              fillColor: ColorConstant.whiteA700,
                                              isDense: true,
                                      ...
                                      child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                              ...
                                              focusedBorder: OutlineInputBorder(
                                                  ...
                                                  borderSide: BorderSide(color: ColorConstant.blue50, width: 1)),
                                              disabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(getHorizontalSize(5.00)), borderSide: BorderSide(color: ColorConstant.blue50, width: 1)),
                                              prefixIcon: Container(margin: EdgeInsets.only(left: getHorizontalSize(18.00), top: getVerticalSize(14.00), right: getHorizontalSize(12.00), bottom: getVerticalSize(14.00)), child: Container(height: getSize(20.00), width: getSize(20.00), child: SvgPicture.asset(ImageConstant.imgPasswordIcon3, fit: BoxFit.fill))),
                                              prefixIconConstraints: BoxConstraints(minWidth: getSize(20.00), minHeight: getSize(20.00)),
                                              filled: true,
                                              fillColor: ColorConstant.whiteA700,
                                              isDense: true,
